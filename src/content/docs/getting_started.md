...
## Configuration
The config can be modified either manually or by using the `/meshlib config` command, which you can read more about [here](https://monkeylib538.docs.offsetmonkey538.top/reference/config_command/).  
...
After you've configured the mod, MESH Lib will need a router that tells it how requests should be handled.  
